...
MODEL_SAVE_PATH = 'real_estate_gradient_boosting.pkl'
...
def train_gradient_boosting():
    ...
    model_pipeline = Pipeline(steps=[
        ...
        ('regressor', GradientBoostingRegressor(n_estimators=300, learning_rate=0.1, max_depth=5, random_state=42))
    ])
    ...
    print("Success: Gradient Boosting pipeline complete!")
