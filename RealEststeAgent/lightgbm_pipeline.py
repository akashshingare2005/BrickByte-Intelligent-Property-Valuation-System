...
MODEL_SAVE_PATH = 'real_estate_lightgbm.pkl'
...
def train_lightgbm():
    ...
    model_pipeline = Pipeline(steps=[
        ...
        ('regressor', LGBMRegressor(n_estimators=500, learning_rate=0.05, num_leaves=31, random_state=42))
    ])
    ...
    print("Success: LightGBM pipeline complete!")
